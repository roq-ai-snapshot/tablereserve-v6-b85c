...
function HomePage() {
  return (
    <>
      <Head>
        <title>TableReserve v6</title>

        <meta
          name="description"
          content="Welcome to TableReserve v6: Revolutionizing the dining experience with seamless table bookings, personalized customer preferences, and optimized restaurant occupancy for unparalleled efficiency."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to TableReserve v6: Revolutionizing the dining experience with seamless table bookings, personalized customer preferences, and optimized restaurant occupancy for unparalleled efficiency.`}
            </Text>
